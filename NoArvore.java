...
public class NoArvore {
	...
	public static void Imp_Ordem(NoArvore tree) { 
		if(tree != null) {
	...
	public static void Imp_Pos(NoArvore tree) {
		if(tree != null) {
	...
	public static void Imp_Pre(NoArvore tree) {
		if(tree != null) {
			System.out.println(tree.info);
	...
	public static NoArvore Search(NoArvore tree, int valor) {
		if(tree == null) {
	...
	public static NoArvore VerificaVazio(NoArvore tree) {
		if(tree == null) {
			return null;
		} else {
			return(tree);
	...
	public static NoArvore InsereRaiz(NoArvore tree, int valor) { //Arvóre vazia
		tree.info = valor;
		tree.direita = null;
		tree.esquerda = null;
		return(tree);
	...
	public static NoArvore Insere(NoArvore tree, int valor) { 
	...
	public static NoArvore Retira(NoArvore tree, int valor) {
		if(tree == null) {
